var unityFramework = ( () => {
    ...
    return (function(unityFramework) {
        ...
        function _DoScrollIntoView() {
            try {
                var elmnt = document.getElementById("unity-canvas-container");
                if (elmnt) {
        ...
        function _IsFakeFullscreen() {
            return /iPhone|iPad|iPod/i.test(navigator.userAgent) || /Macintosh/i.test(navigator.userAgent) && /Safari/i.test(navigator.userAgent) && !/Chrome/i.test(navigator.userAgent)
        }
        function _IsFullscreenSupported() {
            return (document.fullscreenEnabled || document.webkitFullscreenEnabled || document.mozFullScreenEnabled || document.msFullscreenEnabled) && !_IsFakeFullscreen()
        }
        ...
        function _RedirectToURL(str) {
            try {
                var stringifiedUrl = UTF8ToString(str);
                console.log("redirecting entire page to url " + stringifiedUrl);
                window.top.location.href = stringifiedUrl
            } catch (e) {
                (console.error || console.log).call(console, e.stack || e)
            }
        }
        function _OpenNewTab(str) {
            try {
                var stringifiedUrl = UTF8ToString(str);
                console.log("opening window from url " + stringifiedUrl);
                var newWin = window.open(stringifiedUrl);
        ...
        function _Poki_OnPokiSDKLoadedTryInit() {
            try {
                PokiSDK.init().then(function() {
                    console.log("PokiSDK initialized");
                    SendMessage("PokiUnitySDK", "OnPokiSDKScriptsLoaded", 1)
                }).catch(function() {
                    console.log("Poki_TryInit: Adblock detected");
                    SendMessage("PokiUnitySDK", "OnPokiSDKScriptsLoaded", 0)
                })
            } catch (e) {
                (console.error || console.log).call(console, e.stack || e);
                SendMessage("PokiUnitySDK", "OnPokiSDKScriptsLoaded", 0)
        ...
        function _Poki_PreloadScriptsThenInit() {
            try {
                console.log("Poki_TryInit: loading scripts");
                var url = "https://game-cdn.poki.com/scripts/v2/poki-sdk.js";
                var callback = _Poki_OnPokiSDKLoadedTryInit;
        ...
        function _Poki_TryShowInterstial() {
            try {
                PokiSDK.commercialBreak().then(function() {
                    console.log("End of commercial break");
                    SendMessage("PokiAds", "InterstitialDone")
                }).catch(function() {
                    console.log("Poki_TryShowInterstial failed, possibly due to adblock");
                    SendMessage("PokiAds", "InterstitialDone")
                })
            } catch (e) {
                (console.error || console.log).call(console, e.stack || e);
        ...
        function _Poki_TryShowRewarded() {
            try {
                PokiSDK.rewardedBreak().then(function(withReward) {
                    console.log("Should the user get a reward?" + withReward);
                    var adResult = withReward ? 1 : 0;
                    SendMessage("PokiAds", "RewardedAdDone", adResult)
                }).catch(function() {
                    console.log("Poki_TryShowRewarded failed, possibly due to adblock");
                    SendMessage("PokiAds", "RewardedAdDone", 0)
                })
            } catch (e) {
                (console.error || console.log).call(console, e.stack || e);
                SendMessage("PokiAds", "RewardedAdDone", 0)
        ...
        function _SDK_TryShowAd(adType) {
            try {
        ...
        function _WebConsoleException(str, obj) {
            console.error(str, obj)
        }
        function _WebConsoleLog(str) {
            console.log(str)
        }
        ...
        var impl = {
            ...
            isLocked: function() {
                if (this.canvasElement === null) {
                    this.canvasElement = window.document.getElementById("#canvas");
                    if (this.canvasElement === null) {
                        this.canvasElement = window.document.getElementById("unity-canvas")
                    }
                    if (this.canvasElement === null) {
                        throw new Error("CursorLockPlugin: unable to get <canvas> element with id #canvas or unity-canvas")
                    }
                }
                return this.canvasElement === document.pointerLockElement
            }
        };
        function _isLocked() {
        ...
        var asmLibraryArg = {
            "DoKGMEval": _DoKGMEval,
            "DoScrollIntoView": _DoScrollIntoView,
            "GetJSMemoryInfo": _GetJSMemoryInfo,
            "GetURLFromPage": _GetURLFromPage,
            "IsFakeFullscreen": _IsFakeFullscreen,
            ...
            "Poki_OnPokiSDKLoadedTryInit": _Poki_OnPokiSDKLoadedTryInit,
            "Poki_PreloadScriptsThenInit": _Poki_PreloadScriptsThenInit,
            "Poki_TryShowInterstial": _Poki_TryShowInterstial,
            "Poki_TryShowRewarded": _Poki_TryShowRewarded,
            "RedirectToURL": _RedirectToURL,
            "SDK_TryInit": _SDK_TryInit,
            "SDK_TryPreloadAd": _SDK_TryPreloadAd,
            "SDK_TryShowAd": _SDK_TryShowAd,
            ...
            "WebConsoleException": _WebConsoleException,
            "WebConsoleLog": _WebConsoleLog,
        ...
        var dynCall_viiiiffffi = Module["dynCall_viiiiffffi"] = function() {
            return (dynCall_viiiiffffi = Module["dynCall_viiiiffffi"] = Module["asm"]["dynCall_viiiiffffi"]).apply(null, arguments)
        }
        ;
        ...
        var dynCall_viifiiffi = Module["dynCall_viifiiffi"] = function() {
            return (dynCall_viifiiffi = Module["dynCall_viifiiffi"] = Module["asm"]["dynCall_viifiiffi"]).apply(null, arguments)
        }
        ;
        ...
        var dynCall_viffiiffi = Module["dynCall_viffiiffi"] = function() {
            return (dynCall_viffiiffi = Module["dynCall_viffiiffi"] = Module["asm"]["dynCall_viffiiffi"]).apply(null, arguments)
        }
        ;
        ...
        var dynCall_fiifffi = Module["dynCall_fiifffi"] = function() {
            return (dynCall_fiifffi = Module["dynCall_fiifffi"] = Module["asm"]["dynCall_fiifffi"]).apply(null, arguments)
        }
        ;
        ...
        var dynCall_iiiiiiiifi = Module["dynCall_iiiiiiiifi"] = function() {
            return (dynCall_iiiiiiiifi = Module["dynCall_iiiiiiiifi"] = Module["asm"]["dynCall_iiiiiiiifi"]).apply(null, arguments)
        }
        ;
        ...
        var dynCall_iiiiffiiiiiii = Module["dynCall_iiiiffiiiiiii"] = function() {
            return (dynCall_iiiiffiiiiiii = Module["dynCall_iiiiffiiiiiii"] = Module["asm"]["dynCall_iiiiffiiiiiii"]).apply(null, arguments)
        }
        ;
        ...
        var dynCall_iiififiiiii = Module["dynCall_iiififiiiii"] = function() {
            return (dynCall_iiififiiiii = Module["dynCall_iiififiiiii"] = Module["asm"]["dynCall_iiififiiiii"]).apply(null, arguments)
        }
        ;
        ...
        ;
        var dynCall_iiiiiifiiiii = Module["dynCall_iiiiiifiiiii"] = function() {
            return (dynCall_iiiiiifiiiii = Module["dynCall_iiiiiifiiiii"] = Module["asm"]["dynCall_iiiiiifiiiii"]).apply(null, arguments)
        }
        ;
        var dynCall_iffffii = Module["dynCall_iffffii"] = function() {
            return (dynCall_iffffii = Module["dynCall_iffffii"] = Module["asm"]["dynCall_iffffii"]).apply(null, arguments)
        }
        ;
        ...
        var dynCall_viiiiffiiii = Module["dynCall_viiiiffiiii"] = function() {
            return (dynCall_viiiiffiiii = Module["dynCall_viiiiffiiii"] = Module["asm"]["dynCall_viiiiffiiii"]).apply(null, arguments)
        }
        ;
        ...
        var dynCall_viiiiiiiiiffi = Module["dynCall_viiiiiiiiiffi"] = function() {
            return (dynCall_viiiiiiiiiffi = Module["dynCall_viiiiiiiiiffi"] = Module["asm"]["dynCall_viiiiiiiiiffi"]).apply(null, arguments)
        }
        ;
        ...
        ;
        var dynCall_iififiiii = Module["dynCall_iififiiii"] = function() {
            return (dynCall_iififiiii = Module["dynCall_iififiiii"] = Module["asm"]["dynCall_iififiiii"]).apply(null, arguments)
        }
        ;
        ...
        var dynCall_ifffiii = Module["dynCall_ifffiii"] = function() {
            return (dynCall_ifffiii = Module["dynCall_ifffiii"] = Module["asm"]["dynCall_ifffiii"]).apply(null, arguments)
        }
        ;
        ...
        var dynCall_iiiiiffii = Module["dynCall_iiiiiffii"] = function() {
            return (dynCall_iiiiiffii = Module["dynCall_iiiiiffii"] = Module["asm"]["dynCall_iiiiiffii"]).apply(null, arguments)
        }
        ;
        ...
        var dynCall_iifffffii = Module["dynCall_iifffffii"] = function() {
            return (dynCall_iifffffii = Module["dynCall_iifffffii"] = Module["asm"]["dynCall_iifffffii"]).apply(null, arguments)
        }
        ;
        ...
        ;
        var dynCall_iiifffffifi = Module["dynCall_iiifffffifi"] = function() {
            return (dynCall_iiifffffifi = Module["dynCall_iiifffffifi"] = Module["asm"]["dynCall_iiifffffifi"]).apply(null, arguments)
        }
        ;
        ...
        ;
        var dynCall_iiifffifi = Module["dynCall_iiifffifi"] = function() {
            return (dynCall_iiifffifi = Module["dynCall_iiifffifi"] = Module["asm"]["dynCall_iiifffifi"]).apply(null, arguments)
        }
        ;
        ...
        var dynCall_ifffiiiiii = Module["dynCall_ifffiiiiii"] = function() {
            return (dynCall_ifffiiiiii = Module["dynCall_ifffiiiiii"] = Module["asm"]["dynCall_ifffiiiiii"]).apply(null, arguments)
        }
        ;
        ...
        var dynCall_iiffiiii = Module["dynCall_iiffiiii"] = function() {
            return (dynCall_iiffiiii = Module["dynCall_iiffiiii"] = Module["asm"]["dynCall_iiffiiii"]).apply(null, arguments)
        }
        ;
